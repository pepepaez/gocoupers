...
public class  WebServiceDataFields {
    ...
    public static final String FAVLOC_LOCATION_ID = "location_id";
    public static final String FAVLOC_CATEGORY_ID = "category_id";
    public static final String FAVLOC_LOCATION_NAME = "location_name";
    public static final String FAVLOC_LOCATION_LOGO = "location_logo";
    public static final String FAVLOC_NEW_DEAL_COUNT = "CountDeal";
